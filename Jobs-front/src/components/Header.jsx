...
import {openModelSignUp} from '../redux-toolkit/slice/globalSlice.js';
function Header() {
    const dispatch = useDispatch()
    const [openNav, setOpenNav] = React.useState(false);

    const openModels = () => {
        dispatch(openModelSignUp())
    }
    React.useEffect(() => {
    ...
    const navList = (
        <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
            ...
            <Typography as="li" variant="small" color="blue-gray" className="p-1 font-normal pointer"
                onClick={openModels}>
